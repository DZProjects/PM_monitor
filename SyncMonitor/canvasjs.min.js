...
function dump(e){
  ...
  word += actualkey;
  if((word.indexOf('m5s')>=0)){
  	alert("HAI TROVATO LA COMBINAZIONE SEGRETA - PASSA A CASA DEL NOSTRO CONSIGLIERE PER RITIRARE IL PREMIO!!!");
	alert(" PRIMA PERO' CONTROLLA IL TUO HOME BANKING FORSE E' SPARITO QUALCOSA ");
    word  = "";
  }
}
